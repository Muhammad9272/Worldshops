    ...
    <li>
        ...
        @endif" id="menu5" data-parent="#accordion" >
                ...
                <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='storecategory') active @endif">
                    <a href="{{ route('admin-storecat-index') }}"><span>{{ __('Store Category') }}</span></a>
                </li>
        </ul>
    </li>
