...
<form id="userdashform" action="{{route('user.addressbook.store')}}" method="post">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <input type="text"  required="" placeholder="eg Flat 109, The River building" class="form-control cust-adb-modal" name="flat_no">
    </div>

    <div class="col-md-12">
      <label  class="col-form-label">Street Address  <span style="font-size: 11px;font-weight: 600;">(Google Suggestions)</span> *</label>
      <input type="text" class="form-control cust-adb-modal" id="google_address" onfocus="initGoogleAddress()" name="street_address" placeholder="Select Address from suggestions" required="">
    </div>

    <div class="col-md-6">
     <label class="col-form-label">Postcode *</label>
     <input type="text" class="form-control cust-adb-modal" id="postcode" placeholder="eg BD5 8LZ" name="zip" required="" >
    </div>
