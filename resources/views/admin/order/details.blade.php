      ...
      <div class="row">
         ...
         <div class="col-lg-6">
            <div class="special-box">
               <div class="heading-area">
                  <h4 class="title">
                     {{ __('Billing Details') }}{{-- Billing Details --}}
                  </h4>
               </div>
               <div class="table-responsive-sm">
                  <table class="table">
                     <tbody>
                        ...
                        <tr>
                           <th width="45%">{{ __('Flat No') }}</th>
                           <th width="10%">:</th>
                           <td width="45%">{{$order->customer_address}}</td>
                        </tr>
                        <tr>
                           <th width="45%">{{ __('Street_address') }}</th>
                           <th width="10%">:</th>
                        ...
                        <tr>
                           <th width="45%">{{ __('Instructions for rider') }}</th>
                           <th width="10%">:</th>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              @endphp
                              @if(isset($user))
                              <p>{{strlen($product['item']['name']) > 30 ? substr($product['item']['name'],0,30).'...' : $product['item']['name']}}</p>
                              @else
                              <p>
                           ...
                           <td>
                              ...
                              @if(isset($product['free_prod']) && $product['free_prod']>0)
                              <p style="color: green">
                                 <i class="fa fa-gift"></i> +  {{$product['free_prod']}} Free Products
                              </p>
                              @endif
