                     ...
                     <div class="table-responsive">
                        <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    @endif
                                    <p>
                                       <strong>{{ __('Price') }} :</strong> {{$order->currency_sign}}{{ number_format($product['item']['price'] * $order->currency_value , 2) }}
                                    </p>
                                    <p>
                                 ...
                                 <td>{{$order->currency_sign}}{{ number_format($product['price'] * $order->currency_value , 2) }}
                                 </td>
                                 @php
                           ...
                           <tfoot>
                              ...
                              @if($order->tax != 0)
                              <tr>
                                 <td colspan="2">{{ __('Service Charges') }}({{$order->currency_sign}})</td>
                                 @php
