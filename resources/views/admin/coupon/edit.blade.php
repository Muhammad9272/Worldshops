...
@section('content')
            ...
            <div class="content-area" >
              ...
              <div class="mr-breadcrumb">
                  <div class="row">
                      <div class="col-lg-12">
                          <h4 class="heading">Edit Coupon <a class="add-btn" href="{{ route('admin-coupon-index') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                          <ul class="links">
                              <li>
                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row" id="apply_to1" style="display: none; margin-top: 20px;display:{{$data->apply_to== 1 ? "none":"none"}}">
                        ...
                        <div class="form-row" id="apply_to2" style="display: none;margin-top: 20px;display:{{$data->apply_to== 2 ? "none":"none"}}">
                            <div class="form-group col-lg-12">
