            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td class="email-masthead">
                        <p class="padding-10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        <a href="{{ route('front.index') }}" class="f-fallback email-masthead_name">
                ...
                <tr>
                    <td class="email-body" width="570" cellpadding="0" cellspacing="0">
                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td class="bg-image">
                                    <h1 class="main-heading">{{$subject}}</h1>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        <!-- Action -->
                                        @if( $subject=="Reset Password Request" )
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="{{route('user-password-rreset',$email_body)}}" class="f-fallback button button--red" target="_blank">Reset your password</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <p class="text-center font-size-13">Button not working? Follow this link <a href="{{route('user-password-rreset',$email_body)}}" class="grey-link">{{$email_body}}</a></p>
                                        <p class="text-center font-size-13">if you did not request a password reset, you can safety ignore this email. Only a person with access to your email can rest your account password
                                        </p>
                                        @else
                                        <h1 class="text-center">
                                            {!! $email_body !!}
