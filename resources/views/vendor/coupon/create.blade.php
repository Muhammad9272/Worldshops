...
@section('content')
            ...
            <div class="content-area" >
              ...
              <div class="mr-breadcrumb">
                  <div class="row">
                      <div class="col-lg-12">
                          <h4 class="heading">Add Coupon <a class="add-btn" href="{{ route('vendor-coupon-index') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                          <ul class="links">
                              <li>
                        ...
                        <div class="form-row" id="t_check" style="display: none">
                          ...
                          {{-- <div class="form-group">
                              ...
                              <div class="input-group date form_datetime col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                                  ...
                                  <span class="input-group-addon" style="margin-right: 40px;"><span class="fa fa-remove"></span></span>
                        ...
                        <div class="form-row" id="apply_to1" style="margin-top: 20px;display: none">
                            <div class="form-group col-lg-12">
                                <select id="select" multiple="" name="apply_val1[]"  >
                                    ...
                                    $userrr = Auth::user();                                   
                                    @endphp
                                    @foreach($userrr->category()->get() as $category)
