...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">Add Product <a class="add-btn" href="{{ route('vendor-prod-index') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                <ul class="links">
                    <li>
                    ...
                    <div class="body-area">
                        ...
                        <form id="geniusform" action="{{route('vendor-prod-store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="size-area">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        ...
                                                        <input type="number" step="0.01" name="size_price[]" class="input-field" placeholder="Size Price"  value="0" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <input name="price" step="0.01" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" required="" min="0">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <input name="previous_price" step="0.01" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" min="0">
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7">
                                    <div class="checkbox-wrapper">
                                        <input type="checkbox" name="discount_check" value="1" class="checkclick" id="discount_check" value="1">
                                        <label for="discount_check">Product Discount Offers</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="showbox">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="number" class="input-field discount_r" placeholder="Enter quantity" name="buy_quantity">
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="left-area">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="number" step="0.001" class="input-field discount_r" placeholder="Enter amount" name="offer_amount">
                                    </div>
