...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading"> {{-- {{ $langg->lang704 }} --}} Edit Product  <a class="add-btn" href="{{ route('vendor-prod-index') }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                <ul class="links">
                     <li>
                        <a href="{{ route('vendor-dashboard') }}">{{ $langg->lang441 }}</a>
                    </li>
                    <li>
                        <a href="{{ route('vendor-prod-index') }}">{{ $langg->lang444 }} </a>
                    </li>
                    {{-- <li>
                        ...
                        <form id="geniusform" action="{{route('vendor-prod-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <div class="checkbox-wrapper no-display">
                            ...
                            <div class="no-display {{ $data->product_condition == 0 ? " showbox":"" }}">
                                    ...
                                    <div class="col-lg-7">
                                        <select name="product_condition">
                                            <option value="2" {{$data->product_condition == 2
                                                ? "selected":""}}>{{ $langg->lang635 }}
                                            </option>
                                            <option value="1" {{$data->product_condition == 1
                                                ? "selected":""}}>{{ $langg->lang636 }}
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div id="catAttributes" class="no-display">
                                @php
                            ...
                            <div id="subcatAttributes" class="no-display">
                                @php
                            ...
                            <div id="childcatAttributes" class="no-display">
                                @php
                            ...
                            <div class="no-display {{ $data->ship != null ? " ":" showbox" }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-6">
                                                        <label>
                                                            {{ $langg->lang649 }} :
                                                            <span>
                                                                 {{ __('(eg. 500g,1kg,2kg,3kg...)') }}
                                                            </span>
                                                        </label>
                                                        <input type="text" step="0.001" name="size[]" class="input-field" placeholder="{{ $langg->lang649 }}" value="{{ $data->size[$key] }}">
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <label>
                                                            {{ $langg->lang651 }} :
                                                        ...
                                                        <input type="number" name="size_qty[]" class="input-field" step="0.001" placeholder="{{ $langg->lang651 }}" min="1" value="{{ $data->size_qty[$key] }}">
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <label>
                                                            {{ $langg->lang653 }} :
                                                        ...
                                                        <input type="number" name="size_price[]" class="input-field" step="0.01" placeholder="{{ $langg->lang653 }}" min="0" value="{{ $data->size_price[$key] }}">
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                                            ...
                                            <div class="size-area">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        ...
                                                        <input type="number" step="0.001" name="size_qty[]" class="input-field" placeholder="{{ $langg->lang651 }}" value="1" min="1">
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <label>
                                                            {{ $langg->lang653 }} :
                                                        ...
                                                        <input type="number" step="0.001" name="size_price[]" class="input-field" placeholder="{{ $langg->lang653 }}" value="0" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                            ...
                            <div class="no-display {{ !empty($data->color) ? " ":" showbox" }}">
                            ...
                            <div class="no-display {{ $data->measure == null ? 'showbox' : '' }}">
                            ...
                            <div class="row ">
                                <div class="col-lg-4">
                                    <div class="left-area">
                                        <h4 class="heading">Add in Best Offers*</h4>
                                        <p class="sub-heading">{{ $langg->lang668 }}</p>
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="checkbox-wrapper">
                                        <input type="checkbox" name="discount_check" value="1" class="checkclick" id="discount_check" {{ ($data->discount_check == 1) ? 'checked':'' }} value="1">
                                        <label for="discount_check">Product Discount  Offer</label>
                                    </div>
                                </div>
                            </div>

                            <div class="{{ ($data->discount_check == 1) ? '':'showbox' }} " >
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="number" class="input-field discount_r" placeholder="Enter quantity" name="buy_quantity" value="{{$data->buy_quantity}}">
                                    </div>
                                    <div class="col-lg-2">
                                        <div class="left-area">
                                            <h4 class="heading">For Amount *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <input type="number" class="input-field discount_r" placeholder="Enter amount" step="0.001" value="{{$data->offer_amount}}" name="offer_amount">
                                    </div>
                            ...
                            <div class="no-display {{ ($data->meta_tag == null && strip_tags($data->meta_description) == null) ? " showbox":"" }}">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
...
<script type="text/javascript">
            ...
            if(this.checked){
             $('.discount_r').attr('required',true);
             
            }
            else{
              $('.discount_r').attr('required',false);
