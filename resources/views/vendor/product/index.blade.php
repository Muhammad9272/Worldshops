							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links d-inline-flex">
											...
											<li>
												<a href="{{ route('vendor-prod-physical-create') }}">{{ $langg->lang446 }}</a>
											</li>
										</ul>
										<div class="d-inline-flex" style="float: right">
											<a class="btn btn-primary"  href="{{route('vendor-product-csv')}}">Download csv</a>
										</div>
  ...
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
      ...
      <div class="modal-footer justify-content-center">
            ...
            <a class="btn btn-danger btn-ok121">{{ $langg->lang618 }}</a>
      </div>
...
{{--  EDIT Price --}}
										...
										<div class="modal fade" id="modalprice1" tabindex="-1" role="dialog" aria-labelledby="modalprice1" aria-hidden="true">
									                ...
									                <div class="row">
									                  <div class="col-lg-12">
									                    <div class="product-description">
									                      ...
									                      <form id="updateprice" action="" method="POST" enctype="multipart/form-data">
									                        {{csrf_field()}}
									                        ...
									                        <div class="row">
									                          ...
									                          <div class="col-lg-7">
									                            <input type="number" step="0.001" class="input-field prodprice" name="price" placeholder="{{ __('Enter Price') }}" required="" value="">
									                          </div>
									                        </div>
     ...
     $(document).ready(function() {
		var table = $('#geniustable').DataTable({
		      ...
		      $('#confirm-delete').on('show.bs.modal', function(e) {
		          $(this).find('.btn-ok121').attr('href', $(e.relatedTarget).data('href'));
		      });     	
			$('#confirm-delete .btn-ok121').on('click', function(e) {
		        if($('#confirm-delete .btn-ok121').hasClass("order-btn")){
		          if(admin_loader == 1)
		            {
		            $('.submit-loader').show();
		          }
		        ...
		        $.ajax({
		         ...
		         success:function(data)
		         {
		              ...
		              $('.alert-danger').hide();
		              $('.alert-success').show();
		              $('.alert-success p').html("Data Deleted successfully !");
