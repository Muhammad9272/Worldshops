...
@section('content')
	...
	<div class="content-area">
		<div class="mr-breadcrumb">
			<div class="row">
				<div class="col-lg-12">
						<h4 class="heading"> {{ __('Edit Info') }} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
						<ul class="links">
							<li>
							...
							<li>
								<a href="javascript:;">{{ __('Edit Info') }}</a>
							</li>
						</ul>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="product-description">
				        ...
				        <div class="body-area">
				            ...
				            <form id="geniusform" action="{{route('vendor-profile-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
				            {{csrf_field()}}
				               ...
				               @include('includes.admin.form-both')
				                ...
				                <div class="form-body bold-label">
                                    ...
                                    <h4>LocalServe Api Credentials</h4>
				                    <hr>
				                    <div class="row">
				                        <div class="col-md-6">
				                            <label class="control-label" >Localserve email</label>                           
				                            <input type="text" class="form-control"  name="localserve_email" value="{{$data->localserve_email}}" >
				                        </div>
				                         <div class="col-md-6">
				                            <label class="control-label" >Localserve Password</label>                           
				                            <input type="password" class="form-control" value="{{$data->localserve_password}}"  name="localserve_password" >
				                        </div>                       
				                    </div>
				                    ...
				                    <div class="row">
				                        ...
				                        <div class="col-md-6">
				                            ...
				                            <select  id="country" required="" class="form-control" name="store_cat_id" type="text" >
				                    ...
				                    <div class="row">
				                        ...
				                        <div class="col-md-6 display-status {{$data->delivery_method==0?'display-none':''}}">
				                    ...
				                    <div class="row">
				                        ...
				                        <div class="col-md-4">
				                            ...
				                            <div class="fileinput {{$data->doc_1?'fileinput-exists':'fileinput-new'}} mt-20" style="display: block;" data-provides="fileinput">
				                                    ...
				                                    <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput"><i class="fa fa-close"></i>  </a>
				                                </div>
				                        </div> 
				                        <div class="col-md-4">
...
<script type="text/javascript">
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOx84QCQvvypO08b8c2aDSCx80l6OE1tU&callback=initMap&libraries=places&v=weekly" async></script>
