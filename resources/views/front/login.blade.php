...
@section('page_content')
                       ...
                       <div class="ls-login-form signin-form">
                        ...
                        <form id="loginform" action="{{ route('user.login.submit') }}" method="POST">
                          ...
                          <div class="form-group end-t-end">
                              ...
                              <div>
                                <a href="{{route('user-forgot')}}" class="ls-link text-red" >Forgot Password ?</a>
                              </div>                  
                          </div>
                         ...
                         <p class="text-center text-dark mt-20"><strong>OR</strong></p>
                          ...
                          <div class="ls-login-footer text-center">
                            <p>Not Registered ? <span class="text-red"><a href="{{route('user-register')}}" >Join Now</a></span></p>
                          </div>
 ...
 {{-- <div class="ls-social-button">
                        @if(App\Models\Socialsetting::find(1)->f_check == 1)
                        <a class="ls-sl-btn ls-facebook-login" href="{{ route('social-provider','facebook') }}">
                          <p><i class="fa fa-facebook"></i></p><p>Continue with facebook</p>
                        </a>
                        @endif
                        @if(App\Models\Socialsetting::find(1)->g_check == 1)
                         <a class="ls-sl-btn ls-google-login" href="{{ route('social-provider','google') }}">
                          <p><i class="fa fa-google"></i></p><p>Continue with Google</p>
                        </a>
                        @endif
                      </div>
                      <p class="text-center text-dark"><strong>OR</strong></p> --}}
