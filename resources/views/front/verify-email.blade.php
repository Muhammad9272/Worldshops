        ...
        <div class="container ls-content-2">
           ...
           <div class="row vf-email">
             <div class="col-md-6 col-12">
               <div class="contint">
                 <h1 class="fm-cir">Verify your email address</h1>
                 <p class="text-dark pd-lr">We have send 4 digit code to <strong>{{$userdata->email}}</strong>. Please enter that code to verify your email address</p>
                 <div class="vf-content mt-50">
                  @include('includes.admin.form-login')
                   <form method="post" id="verify_account" action="{{route('user-register-token-submit')}}">
                    {{ csrf_field() }}
                     <div class="form-group">
                       <label><strong>Verification Code</strong> </label>
                       <input type="text" name="token_code" class="form-control input-radius" placeholder="Verification code">
                     </div>
                     ...
                     <div class="snd-again end-t-end">
                       <p> <a href="{{route('user-resend-token',$userdata->email)}}" ><strong>Resend Code </strong></a>  </p><p id="verfication-timer" class=" text-dark"></p>
                     </div>
                   ...
                   <div class="verify-info mt-10">
                     ...
                     <p class="mt-50 text-dark" >I have entered wrong <strong> <a href="" class="primary-link">Email Address</a> </strong>  </p>
                   </div>
                 </div>
               </div>
             </div>
           ...
           <div class="text-center">
             ...
             <span><a href="{{route('user-resend-token',$userdata->email)}}" ><strong>Resend Code </strong></a></span>
...
// Set the date we're counting down to
  var countDownDate = new Date('{{$userdata->verification_link_expire}}').getTime();
