        ...
        elseif($status == 'declined') {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Order $data) {
                                ...
                                return '
                                <div class="godropdown"><button class="go-dropdown-toggle"> Actions<i class="fas fa-chevron-down"></i></button><div class="action-list">
    ...
    public function update(Request $request, $id)
    {
        ...
        //--- Redirect Section Ends     
            ...
            if ($input['status'] == "completed"){
                ...
                $extra_charges=($data->gov_bag_charges+$data->sshipping_cost)-$coupon_price;
