    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->editColumn('user_id', function(Coupon $data) {
                                ...
                                if ($data->user_id===0) {
                                   return $data->user_id;
                                    ...
                                    $user_name=$data->user?$data->user->name.' (Seller)':'Seller Deleted';
                                    return $user_name;
                                }
                            ...
                            ->addColumn('action', function(Coupon $data) {
                                return '<div class="action-list"><a href="' . route('admin-coupon-edit',$data->id) . '" class="edit" > <i class="fas fa-edit"></i>Edit</a><a href="javascript:;" data-href="' . route('admin-coupon-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
