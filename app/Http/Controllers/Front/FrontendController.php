...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $mid_small_banner = DB::table('banners')->where('type','=','BottomSmall')->first();
        $large_banner = DB::table('banners')->where('type','=','Large')->first();

	    return view('front.home',compact('mid_small_banner','large_banner','storecats'));
	}
...
// -------------------------------- CONTACT SECTION ----------------------------------------
    ...
    public function contactemail(Request $request)
    {
        ...
        $phone = $request->phone;
        $from = $request->email;
        $msg = "Name: ".$name."<br>Email: ".$from."<br>Phone: ".$request->phone."<br><br>Message: ".$request->text;
        if($gs->is_smtp)
        {
        $data = [
            'to' => $to,
...
// -------------------------------- PRINT SECTION ENDS ----------------------------------------
    ...
    {   
        return view('front.final-payment');
    }
    ...
    {   
        ...
        return view('email.email',compact('order','cart'));
    }

    // public function sendmsg()
    // {
    //     $receiverNumber = " +447376012615 ";
    //     $message = "This is testing from Worldships.co.uk";
