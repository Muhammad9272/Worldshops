                            ...
                            '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                '<div  class="row">'+
                                    '<div class="col-md-4 col-sm-6">'+
                                        '<label>'+
                                        'Size Name :'+
                                            '<span>(eg. 500g,1kg,2kg,3kg...)</span>'+
                                        '</label>'+
                                        '<input type="text" name="size[]" step="0.01" class="input-field" placeholder="'+langg.lang649+'">'+
                                    '</div>'+
                                    '<div class="col-md-4 col-sm-6">'+
                                        '<label>'+
                                        'Size Qty :'+
                                    ...
                                    '<div class="col-md-4 col-sm-6">'+
                                        ...
                                        '</label>'+
                                        '<input type="number" name="size_price[]" step="0.01" class="input-field" placeholder="'+langg.lang653+'" value="0" min="0">'+
                                    '</div>'+
                                '</div>'+
                            '</div>'
                        +'');
                            ...
                            '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                '<div  class="row">'+
                                    ...
                                    '<div class="col-md-4 col-sm-6">'+
                                        ...
                                        '<span>(Number of quantity of this size)</span>'+
                                        '</label>'+
                                        '<input type="number" name="size_qty[]" step="0.01" class="input-field" placeholder="'+langg.lang651+'" value="1" min="1">'+
                                    '</div>'+
                                    '<div class="col-md-4 col-sm-6">'+
                                        '<label>'+
                                        'Size Price :'+
