...
// })
  ...
  // Route::get('/test','Front\FrontendController@test')->name('front.test');

// Route::get('/test/email/{id}', 'Front\FrontendController@emailtest')->name('front.order.emailtest');

Route::get('/test/email1', function()
{
    return view('email.email1');
});
...
Route::get('/test/order', 'Front\StripeController@OrderCallback')->name('front.order.callback');


// Route::get('/smsservice', 'Front\FrontendController@sendmsg')->name('front.sms');
Route::prefix('admin')->group(function() {
  ...
  Route::get('/storecategory/datatables', 'Admin\StoreCategoryController@datatables')->name('admin-storecat-datatables'); //JSON REQUEST
  Route::get('/storecategory', 'Admin\StoreCategoryController@index')->name('admin-storecat-index');
  Route::get('/storecategory/create', 'Admin\StoreCategoryController@create')->name('admin-storecat-create');
  Route::post('/storecategory/create', 'Admin\StoreCategoryController@store')->name('admin-storecat-store');
  Route::get('/storecategory/edit/{id}', 'Admin\StoreCategoryController@edit')->name('admin-storecat-edit');
  Route::post('/storecategory/edit/{id}', 'Admin\StoreCategoryController@update')->name('admin-storecat-update');
  Route::get('/storecategory/delete/{id}', 'Admin\StoreCategoryController@destroy')->name('admin-storecat-delete');
  Route::get('/storecategory/status/{id1}/{id2}', 'Admin\StoreCategoryController@status')->name('admin-storecat-status');
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::get('/general-settings/worldpay/{status}', 'Admin\GeneralSettingController@worldpay')->name('admin-gs-worldpay');
...
Route::prefix('user')->group(function() {
  ...
  Route::get('resend/verification-code/{email}', 'User\RegisterController@generateNewtoken')->name('user-resend-token');
  Route::get('register/verify/{token}', 'User\RegisterController@tokenPage')->name('user-register-token');
  Route::post('register/verify/', 'User\RegisterController@token')->name('user-register-token-submit');



  
  Route::get('two-factor/authentication/{token}', 'User\LoginController@AuthenticationPage')->name('authentication-code-token');
  Route::post('two-factor/authentication/', 'User\LoginController@Authenticationtoken')->name('authentication-code-submit');
  Route::get('resend/authentication-code/{email}', 'User\LoginController@NewAuthenticationtoken')->name('resend-authentication-code');
  ...
  // User Forgot
  Route::get('/forgot-password', 'User\ForgotController@showforgotform')->name('user-forgot');
  Route::post('/forgot-password', 'User\ForgotController@forgot')->name('user-forgot-submit');


  Route::get('/reset-password/{token}', 'User\ForgotController@getPassword')->name('user-password-rreset');
  Route::post('/reset-password', 'User\ForgotController@updatePassword')->name('user-password-rreset-sub');

  // User Forgot Ends


  // User AddressBook Section
  Route::get('/addressbook', 'User\AddressBookController@index')->name('user.addressbook.index');
  Route::get('/addressbook/create', 'User\AddressBookController@create')->name('user.addressbook.create');
  Route::post('/addressbook/create', 'User\AddressBookController@store')->name('user.addressbook.store');
  Route::get('/addressbook/edit/{id}', 'User\AddressBookController@edit')->name('user.addressbook.edit');
  Route::post('/addressbook/edit/{id}', 'User\AddressBookController@update')->name('user.addressbook.update');
  Route::get('/addressbook/delete/{id}', 'User\AddressBookController@destroy')->name('user.addressbook.delete');
 // User AddressBook Section ends
 
  // User SavedCards Section
  Route::get('/savedcards', 'User\UserCreditCardController@index')->name('user.savedcard.index');
  Route::get('/savedcards/create', 'User\UserCreditCardController@create')->name('user.savedcard.create');
  Route::post('/savedcards/create', 'User\UserCreditCardController@store')->name('user.savedcard.store');
  Route::get('/savedcards/edit/{id}', 'User\UserCreditCardController@edit')->name('user.savedcard.edit');
  Route::post('/savedcards/edit/{id}', 'User\UserCreditCardController@update')->name('user.savedcard.update');
  Route::get('/savedcards/delete/{id}', 'User\UserCreditCardController@destroy')->name('user.savedcard.delete');

  Route::get('/savedcards/primary/{id}', 'User\UserCreditCardController@primary')->name('user.savedcard.primary');
 // User SavedCards Section ends

  Route::get('/marketing-preferences', 'User\UserController@marketpreference')->name('user.marketing.preference');
  Route::post('/marketing-preferences', 'User\UserController@marketpreferenceupdate')->name('user.marketing.preference.update');
...
Route::post('the/worldshops/', 'Front\FrontendController@subscription');
...
// ************************************ VENDOR SECTION **********************************************
  Route::get('vendor/new-password/{token}', 'User\LoginController@showVendorPasswordForm')->name('vendor.new.password');
  Route::post('vendor/new-password/{token}', 'User\LoginController@VendorPasswordupdate')->name('vendor.new.password.update');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/password', 'Vendor\VendorController@passwordreset')->name('vendor-password');
  ...
  Route::get('/category/delete/{id}', 'Vendor\CategoryController@destroy')->name('vendor-cat-delete');
  Route::get('/category/status/{id1}/{id2}', 'Vendor\CategoryController@status')->name('vendor-cat-status');
  Route::get('/category/sortable', 'Vendor\CategoryController@Sort')->name('vendor-cat-sort');
 ...
 Route::get('/subcategories/sortable/', 'Vendor\SubCategoryController@Sort')->name('vendor-subcat-sort');
  ...
  Route::get('/load/childcategories/{id}/', 'Vendor\ChildCategoryController@load')->name('vendor-childcat-load'); //JSON REQUEST

  Route::get('/childcategories/sortable/', 'Vendor\ChildCategoryController@Sort')->name('vendor-childcat-sort');
  // CHILDCATEGORY SECTION ENDS------------

  // Vendor Coupon SECTION ENDS------------

  Route::get('/coupon/datatables', 'Vendor\CouponController@datatables')->name('vendor-coupon-datatables'); //JSON REQUEST
  ...
  Route::get('/coupon/delete/{id}', 'Vendor\CouponController@destroy')->name('vendor-coupon-delete');
  ...
  Route::get('/sendordertocourier/{id}', 'Vendor\OrderController@sendtoCourier')->name('vendor-order-courier');
  //------------ ADMIN CATEGORY SECTION ENDS------------
...
Route::get('/products/ccatalog/', 'Vendor\ProductController@prodcatwise')->name('vendor-prodcatwise-index');
Route::get('/products/ccatalog/{category}', 'Vendor\ProductController@prodsubcatwise')->name('vendor-prodsubcatwise-index');
Route::get('/products/ccatalog/{category}/{subcategory}', 'Vendor\ProductController@prodchildcatwise')->name('vendor-prodchildcatwise-index');

Route::get('/products/all/{category}/{subcategory?}/{childcategory?}', 'Vendor\ProductController@index1')->name('vendor-prod-index1');
  ...
  Route::get('/products/datatables', 'Vendor\ProductController@datatables')->name('vendor-prod-datatables'); //JSON REQUEST
   ...
   Route::get('/products/defective', 'Vendor\ProductController@indexdefective')->name('vendor-proddefective-index');



  Route::post('/products/reorder', 'Vendor\ProductController@reorder')->name('vendor-prod-reorder'); //JSON REQUEST
  ...
  Route::get('/products/create', 'Vendor\ProductController@createPhysical')->name('vendor-prod-physical-create');
  ...
  // DELETE SECTION ENDS
  Route::post('/products/bulk/delete/', 'Vendor\ProductController@destroybulk')->name('vendor-prodbulk-delete');

  Route::get('/products/download/csv/', 'Vendor\ProductController@exportCsv')->name('vendor-product-csv');


  Route::get('/products/edit/price/{id}', 'Vendor\ProductController@editPrice')->name('vendor-prod-editPrice');
  Route::post('/products/edit/price/{id}', 'Vendor\ProductController@updatePrice')->name('vendor-prod-updatePrice');
...
Route::get('/package/delete/{id}', 'Vendor\PackageController@destroy')->name('vendor-package-delete');
  ...
  Route::post('/profile/{id}', 'Vendor\VendorController@profileupdate')->name('vendor-profile-update');
  // Vendor Profile Ends
...
// ************************************ FRONT SECTION **********************************************
   Route::get('/get-state-list','GeneralController@getStateList');
   Route::get('/get-uaddress-list','GeneralController@getAddressBook');




  Route::get('/validate-location/{lat}/{long}','GeneralController@ValidateLocation');
  Route::get('/location-set', 'Front\VendorController@locationset')->name('front.location.set');

  Route::get('/', 'Front\FrontendController@index')->name('front.index');

  Route::get('/stores/in/{location}','Front\VendorController@index')->name('front.stores');

  Route::get('/store/{shop_name}/','Front\VendorController@store')->name('front.vendor');

  Route::get('/store/{shop_name}/category/{category}/','Front\VendorController@category')->name('front.vendor.category');

  Route::get('/store/{shop_name}/category/{category}/{subcategory}/','Front\VendorController@subcategory')->name('front.vendor.subcategory');

  Route::get('/store/{shop_name}/product-category/{category}/{subcategory?}/{childcategory?}/','Front\VendorController@childcategory')->name('front.vendor.childcategory');

  Route::get('/product/load/{slug}/', 'Front\VendorController@productload')->name('front.product.load'); 



  // PRODCT AUTO SEARCH SECTION
  Route::get('/autosearch/product/{slug}','Front\VendorController@autosearch');
  // PRODCT AUTO SEARCH SECTION ENDS



  Route::get('/coming-soon', 'Front\FrontendController@comingsoon')->name('front.coming-soon');
 ...
 //************************** Temporary  **************************//
  ...
  // Route::get('/stores', 'Front\FrontendController@store')->name('front.store');
  Route::get('/category', 'Front\FrontendController@category')->name('front.category');
  Route::get('/category/subcategory', 'Front\FrontendController@subcategory')->name('front.subcategory');
  Route::get('/product', 'Front\FrontendController@product')->name('front.product');
  

  // Route::get('/checkout', 'Front\FrontendController@checkout')->name('front.checkout');
  Route::get('/checkout/payment', 'Front\FrontendController@payment')->name('front.checkout.payment');

  // Route::get('/checkout/payment/success', 'Front\FrontendController@paymentsuccess')->name('front.success');
  // Route::get('/checkout/payment/failed', 'Front\FrontendController@paymentfailed')->name('front.payment.failed');



  //************************** User dashboard  **************************//

    // Route::get('/login', 'User\UserDashboardController@showLoginForm')->name('user.login');
    // Route::get('/register', 'User\UserDashboardController@showRegisterForm')->name('user.register');
    // Route::get('/forgot-password', 'User\UserDashboardController@forgot')->name('user.forgot');
    // Route::get('/verify-account', 'User\UserDashboardController@verify')->name('user.verify');




  // Route::get('user/dashboard', 'User\UserDashboardController@dashboard')->name('user.dashboard');
  

  Route::get('user/order', 'User\UserController@order')->name('user.order');
  Route::get('user/order/details', 'User\UserController@orderdetail')->name('user.order.detail');
  Route::get('user/refer-friend', 'User\UserController@referfriend')->name('user.refer.friend');
  ...
  Route::get('menu/index','TestController@index');
  Route::post('menu/update-order','TestController@updateOrder'); 

  // // CONTACT SECTION
  Route::get('/contact','Front\FrontendController@contact')->name('front.contact');
  Route::post('/contact','Front\FrontendController@contactemail')->name('front.contact.submit');

  Route::get('/customer/support','Front\FrontendController@support')->name('front.support');
  Route::post('/customer/support','Front\FrontendController@supportemail')->name('front.support.submit');
  ...
  // // CART SECTION
  Route::get('/carts/view/{ck?}','Front\CartController@cartview');
  ...
  Route::get('/shipchange/{id}','Front\CartController@shipchanges')->name('product.shipchange');
  Route::get('/carts/coupon/','Front\CartController@coupon');
  // Route::get('/carts/coupon/check','Front\CartController@couponcheck');
  // // CART SECTION ENDS

  // // CHECKOUT SECTION
  Route::post('/checkout/note', 'Front\CheckoutController@checkoutnote')->name('front.checkoutnote');
  ...
  Route::post('/worldpay-submit', 'Front\WorldPayController@store')->name('worldpay.submit');
  ...
  Route::post('/vendor/contact','Front\VendorController@vendorcontact')->name('customer.vendor.contact');
  // // TAG SECTION ENDS
